...
<html lang="en">
    ...
    <body id="body">
        ...
        <div id="datastar" class="container">
            ...
            <div class="page">
                <div class=""><a href="{{ url('home') }}">หน้าแรก</a> / </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    >
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img src="http://127.0.0.1:8000/image/girl.png"
                           >
                        </div>
                        <div class="swiper-slide">
                            <img src="http://127.0.0.1:8000/image/girl1.png" >
                        </div>
                        {{-- <div class="swiper-slide">
                ...
                <div class="col-sm-7">
                    ...
                    <div class="content-top">
                        <div class="content-down">สถานที่รับงาน/Zone : </div>
                        <div class="content-down content-lo"> <img class="img-lo" src="{{ url('/images/location.png') }}"
                                alt="Image" /> , <img class="img-lo" src="{{ url('/images/location.png') }}"
                                alt="Image" />, <img class="img-lo" src="{{ url('/images/location.png') }}"
                                alt="Image" />,<img class="img-lo" src="{{ url('/images/location.png') }}"
                                alt="Image" />
                             </div>
                    ...
                    <div class="content-top">
                        <div class="col-sm-12">
                            <div class="content-down">เพศ :</div>
                            <div class="content-down">อายุ : </div>
                            <div class="content-down">สัดส่วน </div>
                            <div class="content-down">ส่วนสูง : </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="content-down">น้ำหนัก : </div>
                        </div>
                        <div class="col-sm-6">
...
<style>
    #datastar .swiper-container {
      width: 100%;
      height: 100%;
    }

    #datastar .swiper-slide {
      text-align: center;
      font-size: 18px;
      background: #fff;
    ...
    #datastar .mySwiper  .swiper-slide {
      width: 25%;
      height: 100%;
      opacity: 0.4;
    }

    #datastar .mySwiper  .swiper-slide-thumb-active {
      opacity: 1;
    }
