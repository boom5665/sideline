        ...
        <div class="dis-between dis-box">
            <div>
                <div class="col-con">
                    ...
                    <p>เชิญหนุ่มๆแวะเข้ามาเยี่ยมชม ทักทายคุย กันก่อนคะ รับรองไม่ผิดหวัง ถ้าไม่ดี เอารองเท้าแตะมาเฟี้ยงได้เลย
                        😋😋</p>
                    <br>
            ...
            <div class="dis-colum">
                ...
                <div class="col-con dis-cen">
                    ...
                    <button class="but-f"><img src="{{ url('/images/twitter.png') }}" alt="Image"
                            class="img-f"></i></button>
                    <button class="but-f"><img src="{{ url('/images/line.png') }}" alt="Image" class="img-f"></i></button>
                </div>
